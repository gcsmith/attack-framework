...
class crypto_grostl_dp512_hd_r0: public crypto_instance {
public:
    ...
    virtual int compute(int n, int k) {
        ...
        const int q = ((~n & 7) ? m_msg[n] : m_msg[n] ^ ((n & ~7) << 1)) ^ 0xFF;
...
register_crypto(grostl_dp512_hd_r0, crypto_grostl_dp512_hd_r0);
