...
// -----------------------------------------------------------------------------
void crypto_aes_hd_r0::set_message(const std::vector<uint8_t> &msg)
{
    m_msg = msg;
}

// -----------------------------------------------------------------------------
void crypto_aes_hd_r0::set_key(const std::vector<uint8_t> &key)
{
    m_key = key;
}

// -----------------------------------------------------------------------------
int crypto_aes_hd_r0::extract_estimate(int k)
{
    return m_key[k];
}
